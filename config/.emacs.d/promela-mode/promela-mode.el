...
indent the current line before running a regular 'newline-and-indent'."
  (interactive)
...
(defun promela-open-delimiter ()
  "Insert the open and matching close delimiters, indenting as appropriate."
  (interactive)
  (insert last-command-event)
...
(defun promela-close-delimiter ()
  "Insert and indent a close delimiter."
  (interactive)
  (insert last-command-event)
...
(defun promela-effective-eolp (&optional point)
  "Check if we are at the effective 'end-of-line' given optional POINT, \
ignoring whitespace."
  (save-excursion
